<div class="container-fluid p-5">
  <div class="row">
    ...
    <div class="col-lg-8">
      <div class="tab">
        <btnto type="button" class="btnto buttwo1 active" onclick="openCity(event, 'BT')">Berita Terbaru</btnto>
              ...
              <img src="<?php echo base_url('assets/img/Rectangle 13 (2).png ') ?>" class="card-img-top" src="..." alt="Card image cap">
                <div class="card-body">
                  <div class="row mx-md-n5 my-3">
                    ...
                    <h5 class="card-title"><b>ARC USK Beri Pelatihan Produk Inovasi Nilam Kepada UMKM Makassar</b></h5>
                </div>
            </div>
            <div class="card">
              <img src="<?php echo base_url('assets/img/Rectangle 27.png ') ?>" class="card-img-top" src="..." alt="Card image cap">
                  <div class="card-body">
                    <div class="row mx-md-n5 my-3">
                      <div class="col px-md-5">
                        <i><iconify-icon icon="fluent:rectangle-landscape-28-filled" style="color: #d9d9d9;"></iconify-icon></i> 
                      ...
                      <h5 class="card-title"><b>Silaturahmi Ramadhan II</b></h5>
                  </div> 
            </div>
          </div> 
            ...
            <div class="col-lg-8">
              <div class="card-body">
                  ...
                  <div class="text-justify">
                    ...
                    <button type="button" class="btn btn-dark">Baca Selengkapnya</button>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card">
